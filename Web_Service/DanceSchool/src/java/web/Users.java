...
@NamedQueries({
    ...
    , @NamedQuery(name = "Users.deleteByUsername", query = "DELETE FROM Users WHERE username = :username")
    ...
    , @NamedQuery(name = "Users.findPaybyStudentID", query = "SELECT p from Users u join u.paymentsCollection p where u.id =:studentID")
