...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
 ...
 <br>
   ...
   <h1 class="mt-4 mb-3 text-white animated bounceInDown"><b><?php echo returnName(returnMemberID()); echo "'s profile";?></b></h1>
     ...
     <ol class="breadcrumb bg-dark animated bounceInLeft">
       ...
       <li class="breadcrumb-item active"> <?php echo returnName(returnMemberID()); echo "'s profile";?></li>
     </ol>
