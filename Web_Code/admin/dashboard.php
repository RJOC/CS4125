...
<body>
  ...
  <div class="col-md-4 col-md-offset-4">
      ...
      <ul class="list-group">
        ...
        <a href="<?php echo BASE_URL . 'admin/users/userList.php' ?>" class="list-group-item">Manage Admins</a>
        <a href="<?php echo BASE_URL . 'admin/roles/roleList.php' ?>" class="list-group-item">Manage Roles</a>
        <a href="<?php echo BASE_URL . 'admin/users/memberList.php' ?>" class="list-group-item">Manage Members</a>
      </ul>
  </div>
