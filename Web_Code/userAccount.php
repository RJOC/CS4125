...
<head>
    ...
    <!-- General styling of the main page -->
    <style>
        .centered {
            position: absolute;
            top: 90%;
...
<body>
    ...
    <!-- View Classes -->
    <div id="show-classes">
        <section id="show-classes" style="background-image:url('img/dance_revolution.jpg'); background-repeat:no-repeat;background-size: 100% 100%;opacity:100%" class="home-section color-dark bg-white">
            <!-- Displaying the calndar -->
            <div id="calendar_div">
